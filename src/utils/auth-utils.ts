...
export const clearAuthData = (is_reload: boolean = true): void => {
    safeRemoveItem('accountsList');
    safeRemoveItem('clientAccounts');
    safeRemoveItem('callback_token');
    safeRemoveItem('authToken');
    safeRemoveItem('active_loginid');
    safeRemoveItem('client.accounts');
    safeRemoveItem('client.country');
