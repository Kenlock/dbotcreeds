...
import { syncSelectedDerivAccount } from '@/utils/deriv-session';
...
const AccountSwitcher = observer(({ activeAccount }: TAccountSwitcher) => {
    ...
    const switchAccount = async (loginId: number) => {
        ...
        await syncSelectedDerivAccount(loginId.toString()).catch(error => {
            console.warn('[Deriv] account selection sync failed:', error);
        });
        const account_type =
            loginId
                .toString()
